...
public class Import {
	...
	private JsonObject readProfileItem(final JsonReader reader) throws IOException {
		...
		while (reader.hasNext()) {
			...
			LOGGER.debug("readProfileItem: objectNewsDataName: '" + objectNewsDataName + "'");
	...
	private JsonArray readMoreExport2(final JsonReader reader) throws IOException {
	...
	private JsonArray readMoreExport3(final JsonReader reader) throws IOException {
	...
	private JsonObject readMoreExport4(final JsonReader reader) throws IOException {
