...
public class ProfilePersistV1 {
	...
	private ProfileData loadOldProfileObject(final String key) {
		...
		pd.setText("timelineTimePadding", child.get("timelineTimePadding", ""));
		pd.setSelected("cbTimeLineAddTimePerScene", setupCBSelectedValueFromOld("cbTimeLineAddTimePerScene",
				child.get("cbTimeLineAddTimePerScene", "false")));
	...
	public void saveProfiles(final ProfileData pd) throws BackingStoreException {
		...
		setValueIfNotNull(child, "outputFileTextCharCard", pd.getText("outputFileTextCharCard"));
		setValueIfNotNull(child, "timelineTimePadding", pd.getText("timelineTimePadding"));
		setValueIfNotNull(child, "cbTimeLineAddTimePerScene", pd.getText("cbTimeLineAddTimePerScene"));
